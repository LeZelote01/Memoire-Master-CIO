...
\hypersetup{
    ...
    pdfkeywords={IoT, Firmware, Sécurité, ESP32, Crypto Intégré, Sécurité Matérielle}
}
...
\newcommand{\titre}{Détection et prévention des attaques par compromission de firmware dans les dispositifs IoT grand public : Conception d'un Framework léger de vérification d'intégrité exploitant les capacités cryptographiques intégrées ESP32}
